...
beautiful.init("/home/hashwarlock/.config/awesome/theme.lua")
...
mytextclock = wibox.widget.textclock("%F %R")
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.margin(awful.widget.watch([[
                bash -c "cat `ls -d /home/hashwarlock/omega/Journal/*.* | tac | head -n 1` | grep --color=never -e '- \\[ \\]' | head -n 1 | cut -c 7-"
            ]], 10), 12, 12, 6, 6),
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "s", function () awful.spawn({"flameshot", "gui"}) end,
              {description = "make a screenshot", group = "util"}),
